...
public class CuciSetrika extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuci_setrika);
        viewlistback = findViewById(R.id.listback);

        viewlistback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CuciSetrika.this, MainActivity.class));
            }
        });
//        tshirt
